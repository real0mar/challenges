...
def add_line_points(bounds: int, locations: set[tuple[int, int]], start: tuple[int, int], dX: int, dY: int) -> None:
    ...
    for positions in antenna_info.values():
        for pos1, pos2 in itertools.combinations(positions, 2):
            ...
            if dX == 0:
                ...
                dX //= gcd
                dY //= gcd
                add_line_points(bounds, locations, (pos1[0] - dX, pos1[1] - dY), -dX, -dY)
